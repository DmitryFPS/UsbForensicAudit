...
/// машинами), и в московском (чтение человеком). Возвращает строку: запись на
/// диск и кодировку выбирает вызывающий слой.
/// </summary>
public static class TimelineCsvExporter
{
    private static readonly string[] Headers =
    [
        "Время (UTC)", "Время (МСК)", "Источник", "Провайдер", "Канал",
