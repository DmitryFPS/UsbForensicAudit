...
public static class ManualPdfGenerator
{
    ...
    private static void AddDevicesTab(ColumnDescriptor column)
    {
        ...
        Bullet(column, "Рядом с ним Windows заводит запись на каждую услугу: громкая связь, передача файлов, "
                       + "доступ к книге контактов, выход в сеть. У одного телефона таких записей полтора десятка, "
                       + "и они окрашены как части устройства: это возможности соединения, а не отдельные вещи.");
