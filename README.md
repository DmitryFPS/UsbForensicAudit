...
(MountPoints2 — какой пользователь обращался к какому тому). Кусты
предварительно копируются во временный каталог — исследуемые файлы не
изменяются. Журналы событий, WMI и работающие процессы чужой машины
