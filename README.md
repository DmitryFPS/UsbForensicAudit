...
- Отчёты **HTML**, **PDF** и **Excel** (полный и сводный) на русском ����з��ке с корректной кириллицей. **Область отчёта — только USB/Type-C**; ОЗУ и внутренние SATA/NVMe исключены.
